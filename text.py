...
input_search_word = 'Введите слово для посика: '
...
input_id_change_contact = '’Введите 10 контакта, который хотите изменить: '

change_contact = ['Введите новое имя или ентер, чо бы оставить без изменененийЖ ',
                  'Введите номер телефона или ентер, что бы оставить без измнений',
...
input_id_delete_contact = 'Введите ид контакта, который хотите удалить'
